...
\lstdefinelanguage{VHDL}{
  morekeywords=[1]{ 		%Defineren van keywords die blauw worden
    ...
    begin,and,or,not,downto,ALL,signal,type,case,if,elsif,else,then,for,when,array,
...
\title[Extreme Winterslaap Interrupter\\ Final report\\ \\ 12-12-12]{EPO-3}
...
\input{appendix_controller_sim}
\input{appendix_alarm_vhdl}
