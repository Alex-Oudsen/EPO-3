...
\item De buffer die er voor zorgt dat er maar 1 klok periode input wordt gezien door de menu de code is te vinden in \cref{code:buffer_ent,code:buffer_beh}.
\end{itemize}
